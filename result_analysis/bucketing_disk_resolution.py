...
ROME_CHOSEN_DATA = f"{project_root}/{ROME_OUTPUT_FOLDER}/"
ROME_META_TEST = f"{project_root}/{ROME_OUTPUT_FOLDER}/META-{NUMBER_OF_TRAJECTORIES}.txt"

TRUE_SIMILARITIES_OUTPUT_FOLDER_PORTO = "/results_true/similarity_values/porto/"
TRUE_SIMILARITIES_OUTPUT_FOLDER_ROME = f"{project_root}/results_true/similarity_values/rome/"

# print(f"{project_root}{TRUE_SIMILARITIES_OUTPUT_FOLDER_ROME}dtw/rome-dtw-{NUMBER_OF_TRAJECTORIES}.csv")
...
#     pd.read_csv(
#         f"{TRUE_SIMILARITIES_OUTPUT_FOLDER_PORTO}/porto-dtw-{NUMBER_OF_TRAJECTORIES}.csv",
#         index_col=0,
#     )
# ).flatten()
R_DTW = _mirrorDiagonal(
    pd.read_csv(
        f"{TRUE_SIMILARITIES_OUTPUT_FOLDER_ROME}dtw/rome-dtw-{NUMBER_OF_TRAJECTORIES}.csv",
        index_col=0,
    )
).flatten()
# P_FRE = _mirrorDiagonal(
#     pd.read_csv(
#         f"{TRUE_SIMILARITIES_OUTPUT_FOLDER_PORTO}/porto-frechet-{NUMBER_OF_TRAJECTORIES}.csv",
#         index_col=0,
#     )
# ).flatten()
# R_FRE = _mirrorDiagonal(
#     pd.read_csv(
#         f"{TRUE_SIMILARITIES_OUTPUT_FOLDER_ROME}/rome-frechet-{NUMBER_OF_TRAJECTORIES}.csv",
#         index_col=0,
#     )
# ).flatten()
...
def get_folder_paths(city: str) -> tuple:
    if city.lower() == "porto":
        return TRUE_SIMILARITIES_OUTPUT_FOLDER_PORTO, PORTO_CHOSEN_DATA
    elif city.lower() == "rome":
        return TRUE_SIMILARITIES_OUTPUT_FOLDER_ROME, ROME_CHOSEN_DATA
...
def get_meta_file(city: str, size: int) -> str:
    if city.lower() == "porto":
        ...
        print("DETTE ER FIL-destinasjonen", f"{ROME_OUTPUT_FOLDER}META-{size}.txt")
        return ROME_META_TEST
