...
from edit_distance import edit_distance as p_ed

from edit_distance_penalty import edit_distance_penalty as p_edp
import os, sys
currentdir = os.path.dirname(os.path.abspath("__file__"))
parentdir = os.path.dirname(currentdir)
sys.path.append(parentdir)
from utils.similarity_measures.dtw import dtw as p_dtw
